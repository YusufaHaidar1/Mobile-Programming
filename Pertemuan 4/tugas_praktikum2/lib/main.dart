...
class _TemperatureConverterState extends State<TemperatureConverter> {
  ...
  void convertTemperature() {
    setState(() {
      ...
      String historiEntri = 
      '$inputValue ${selectedUnit} = $result Celsius';
      historiKonversi.add(historiEntri);
    });
  }
          ...
          children: <Widget>[
            ...
            Expanded(
              child: ListView.builder(
                itemCount: historiKonversi.length,
                itemBuilder: (context, index){
                  return ListTile(
                    title: Text(historiKonversi[index], textAlign: TextAlign.center),
                  );
                }
              ) 
            )
